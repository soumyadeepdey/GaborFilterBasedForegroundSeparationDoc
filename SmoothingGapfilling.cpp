...
Mat IITkgp_functions::horizontal_smoothing(Mat image, int whitespace)
{
    int i,j,k;
    //int row = image.rows;
    //int col = image.cols;
...
Mat IITkgp_functions::horizontal_gapfilling(Mat image, int whitespace)
{
    int i,j,k,l;
...
Mat IITkgp_functions::vertical_smoothing(Mat image,int whitespace)
{
    int i,j,k;
...
Mat IITkgp_functions::vertical_gapfilling(Mat image,int whitespace)
{
    int i,j,k,l;
...
void gapped(int, void*)
{
    ...
    GapImage = vertical_gapfilling(TempImage,vgapsize);
    GapImage = horizontal_gapfilling(GapImage,hgapsize);
...
void smooth(int, void*)
{
    ...
    GapImage = vertical_smoothing(TempImage,vgapsize);
    GapImage = horizontal_smoothing(GapImage,hgapsize);
...
Mat IITkgp_functions::smoothinggapfilling_GUI(Mat image, int sgtype)
{
